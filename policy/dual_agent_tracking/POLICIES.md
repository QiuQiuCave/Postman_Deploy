...
15 lower-body joint pos/vel (in `g1_lower_body_joint_names` order) + torso_link
world pose. Generated by `upper_lower/scripts/factoryIsaac/dual_agent_tracking_preprocess_motion.py`
from `data/demo/lafan/walk4_subject1.npz`.

| File | Source motion | Date | Status |
|---|---|---|---|
| `walk_tracking_ref.npz` | active | — | runtime artifact |
